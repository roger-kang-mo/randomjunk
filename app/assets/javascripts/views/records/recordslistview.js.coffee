...
BackboneHolder.RecordsListView = Backbone.View.extend
	...
	render: (className) ->
		...
		@$el.html('<tr><th class="player" data-sort="name">Name <span class="sort-icon"></span></th><th class="time" data-sort="time">Time <span class="sort-icon"></span></th><th class="dimensions" data-sort="dimensions">Height x Width <span class="sort-icon"></span></th><th class="mines" data-sort="mines"># Mines <span class="sort-icon"></span></th></tr>')
