module CardsAgainstHumanityCards
	WHITE_CARDS = ["A Gypsy curse.",
		"A moment of silence.",
		"A sausage festival.",
	...
	WHITE = CardsAgainstHumanityCards.const_get('WHITE_CARDS')
	BLACK = CardsAgainstHumanityCards.const_get('BLACK_CARDS')

	def self.get_card (get_white=true, get_black=true)
		cards = Hash.new
		cards['white'] = WHITE[rand(WHITE.length)] if get_white
		cards['black'] = BLACK[rand(BLACK.length)] if get_black
		cards
	end
